...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        let a = ViewPoint(title: "dit",subtitle: "my dream",coordinate: center );
        let b = ViewPoint(title: "시민공원",subtitle: "재밌는곳",coordinate: CLLocationCoordinate2D(latitude: 35.168444,longitude: 129.057832));
        let c = ViewPoint(title: "test",subtitle: "test",coordinate: CLLocationCoordinate2D(latitude: 35.164444,longitude: 129.047832));
